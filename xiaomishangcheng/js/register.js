    ...
    return {
        ...
        event: function() {
            ...
            this.$loginBtn.onclick = function() {
                ...
                sendAjax('http://localhost/xiaomishangcheng/php/register.php', params);
            }
            this.$usernameInp.onchange = function(){
                ...
                sendAjax('http://localhost/xiaomishangcheng/php/check_username.php', params);
            }
        },
